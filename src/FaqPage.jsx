...
const FAQ = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What does catering usually cost?",
        a: "Most catering orders start around $400, depending on how many trays you need and which dishes you choose." },
      ...
      { q: "How far in advance should I order?",
        a: "", todo: "Minimum notice, e.g. 48 hours? A week for large orders?" },
      { q: "Do you deliver catering orders?",
        a: "", todo: "Delivery radius, fee, and whether pickup is an option." },
      { q: "Do you require a deposit?",
        a: "", todo: "Deposit amount, and when the balance is due." },
      ...
      { q: "Do trays come with serving utensils or setup?",
        a: "", todo: "What's included: utensils, plates, chafing dishes, setup/staff?" },
      { q: "Can you work around allergies for a group?",
        a: "Our menu marks vegan, vegetarian and gluten-free dishes, and labels which dishes contain nuts, so you can plan around most needs.",
        todo: "Anything you can prepare specially on request?" },
    ],
  },
];
